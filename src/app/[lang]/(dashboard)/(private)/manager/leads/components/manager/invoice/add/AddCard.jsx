...
const AddAction = (props) => {
  console.log("props data from invoice add", props.saleid);
  ...
  // Add new state for company logo
  ...
  const handleSubmit = async e => {
    ...
    const dataIn = { items: formData, ...totals, dateIssued: issuedDate, dueDate: dueDate, customer: props.data?._id, notes: note, sales: props.saleid }
