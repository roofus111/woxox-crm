...
const Page = () => {
  ...
  return (
        <div className='flex min-h-screen bg-gray-50'>
          {/* Fixed Left Panel - Progress */}
          <div className='hidden lg:flex lg:w-1/3 fixed left-0 top-0 h-full bg-white shadow-sm border-r border-gray-200 p-8 flex-col justify-between z-10'>
            <div>
              <Link href="/">
              ...
              <div className='space-y-6 relative'>
                {/* Progression Line */}
                <div className='absolute left-4 top-8 bottom-0 w-0.5 bg-gray-200 -z-10'>
                  <div 
                    className='w-full bg-blue-600 transition-all duration-500 ease-in-out' 
                    style={{ height: `${(activeTab / 2) * 100}%` }}
                  ></div>
                </div>

                <div className={`flex items-center space-x-4 relative ${activeTab >= 0 ? 'text-black' : 'text-gray-400'}`}>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-300 ${
                    activeTab >= 0 ? 'bg-blue-600 text-white shadow-lg' : 'bg-gray-300 text-gray-600'
                  }`}>
                    {activeTab > 0 ? '✓' : '1'}
                  </div>
                  <div>
                ...
                <div className={`flex items-center space-x-4 relative ${activeTab >= 1 ? 'text-black' : 'text-gray-400'}`}>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-300 ${
                    activeTab >= 1 ? 'bg-blue-600 text-white shadow-lg' : 'bg-gray-300 text-gray-600'
                  }`}>
                    {activeTab > 1 ? '✓' : '2'}
                  </div>
                  <div>
                    <div className='font-semibold'>Survey</div>
                    <div className='text-sm text-gray-500'>Help us understand your needs</div>
                  </div>
                </div>

                <div className={`flex items-center space-x-4 relative text-gray-400`}>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-300 bg-gray-300 text-gray-600`}>
                    3
                  </div>
                  <div>
                    <div className='font-semibold'>Verify</div>
                    <div className='text-sm text-gray-500'>Submit your certification details</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                {[0, 1, 2].map((step) => (
                  <div
                    ...
                    className={`w-2 h-2 rounded-full transition-all duration-300 ${
                      step <= activeTab ? 'bg-blue-600' : 'bg-gray-300'
                    }`}
                  />
                ))}
              </div>
      ...
      {/* Right Panel - Form */}
        <div className='flex-1 lg:ml-[33.333333%] flex items-center justify-center p-6 min-h-screen overflow-y-auto'>
